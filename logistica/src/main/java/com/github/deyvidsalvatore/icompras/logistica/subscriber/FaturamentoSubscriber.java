package com.github.deyvidsalvatore.icompras.logistica.subscriber;

import com.github.deyvidsalvatore.icompras.logistica.service.EnvioPedidoService;
import com.github.deyvidsalvatore.icompras.logistica.subscriber.representation.AtualizacaoFaturamentoRepresentation;
...
public class FaturamentoSubscriber {
    ...
    public void listen(String json) {
        ...
        try {
            ...
            log.error("Erro ao receber pedido para envio", e);
        }
